...
public record RegionSoundStatePayload(String soundID, boolean play, float volume, float fadeDuration) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, RegionSoundStatePayload> CODEC = PacketCodec.tuple(
            ...
            PacketCodecs.FLOAT, RegionSoundStatePayload::volume,
            PacketCodecs.FLOAT, RegionSoundStatePayload::fadeDuration,
